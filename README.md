...
<!-- usage -->
```sh-session
$ npm install -g localize-tools-cli
$ cli COMMAND
running command...
$ cli (--version)
localize-tools-cli/0.0.0 linux-x64 node-v18.4.0
$ cli --help [COMMAND]
USAGE
  $ cli COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/andersonmfjr/localize-tools-cli/blob/v0.0.0/dist/commands/hello/index.ts)_
